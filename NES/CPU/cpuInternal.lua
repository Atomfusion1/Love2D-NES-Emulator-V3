...
cpuInternal.statusRegister = 0x24   -- 0x20 (unused bit set) | 0x04 (interrupt disable)
...
cpuInternal.flag           = {
    ...
    ["unused"]    = 0x20,   -- 5 = always high Not Used
    ["breakflow"] = 0x10,   -- 4 = breakflow flag B
    ["decimal"]   = 0x08,   -- 3 = decimal flag D
    ["interrupt"] = 0x04,   -- 2 = interrupt flag I
    ["zero"]      = 0x02,   -- 1 = zero flag Z
    ["carry"]     = 0x01,   -- 0 = carry flag C
}
